/*
By default Query Analyzer (ISQLW) displays only 256 characters per line in the results tab. 
You can configure Query Analyzer to display a maximum of 8192 lines per line. Follow these steps:
